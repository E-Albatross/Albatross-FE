...
const ExLine = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* 세로줄 */}
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 50, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 100, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 150, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 200, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 250, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 300, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 350, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 400, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 450, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 500, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 550, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 600, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 650, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 700, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 750, top: 70, }} />
      <View style={{ height: 1220, width: 1, backgroundColor: "#C4C4C4", position: "absolute", left: 800, top: 70, }} />
    </View>
  );
};
